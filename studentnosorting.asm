...
# lw sw
######################################################################################################################### instr.(H) ####### addr.(H)
      lui     $2, 0x1145          # high halfword the student no (last 8 digitals), use your own student no. instead!      # 0                0
      ori     $2, $2, 0x0218      # low halfword of the student no (last 8 digitals)                                       # 1                4
